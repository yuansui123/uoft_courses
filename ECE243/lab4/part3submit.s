...
KEY_ISR:        
				...
				LDR   R8, =0xFFFEC600 //Private timer
				...
				//MOVEQ R6, #0
				CMP R11, #1
				EOREQ R6, #1       //This alternates RUN (between 1 and 0)
                ...
                POP {R6, R8, R10, R11, LR}
                MOV      PC, LR

KEY_1:          PUSH {R8, R9, R10, LR}
                LDR   R8, =0xFFFEC600
				LDR   R9, [R8]
				MOV   R10, #0
                STR   R10, [R8, #0x8]
